...
class ProductionInference:
    def __init__(self):
        ...
        self.model_path = os.path.join(self.base_dir, 'model_int8.tflite')
    ...
    def _predict_prob(self, feat_input):
        ...
        if self.input_details['dtype'] == np.int8:
            ...
            tensor = (tensor / in_scale + in_zero).astype(np.int8)
    ...
    def listen(self):
        ...
        print("\nMonitoring room (SILICON-23 INT8 binary dog bark policy)")
        print("-" * 72)
