...
elseif(APPLE)
  set(TOOLCHAIN_DIR "/Users/theepireddykarthikreddy/.silabs/slt/installs/conan/p/gcc-af360b79bab9e3/p//bin/")
else()
  set(TOOLCHAIN_DIR "/bin/")
endif()
...
elseif(WIN32)
  set(POST_BUILD_EXE "")
elseif(APPLE)
  set(POST_BUILD_EXE "/Users/theepireddykarthikreddy/.silabs/slt/installs/archive/Commander.app/Contents/MacOS/commander")
else()
  set(POST_BUILD_EXE "")
endif()
...
elseif(APPLE)
  set(NINJA_RUNTIME_PATH "/Users/theepireddykarthikreddy/.silabs/slt/installs/conan/p/ninja48deaaf744f20/p/ninja")
else()
  set(NINJA_RUNTIME_PATH "")
endif()
